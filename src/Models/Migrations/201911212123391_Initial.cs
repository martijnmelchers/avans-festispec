                ...
                c => new
                    {
                        ...
                        Address_StreetName = c.String(maxLength: 50),
                        Address_HouseNumber = c.Int(),
                        Address_Suffix = c.String(maxLength: 10),
                        Address_City = c.String(maxLength: 200),
                        Address_Country = c.String(maxLength: 75),
                        OpeningHours_StartTime = c.DateTime(false),
                        OpeningHours_EndTime = c.DateTime(false),
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(nullable: false),
